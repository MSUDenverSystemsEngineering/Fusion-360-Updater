...
Try {
	...
	[string]$appName = 'Fusion 360'
	[string]$appVersion = 'January 2023'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '02/15/2023'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'fusion360' -CheckDiskSpace -PersistPrompt
		...
		#Copies update batch file from Autodesk to shared directory per Autodesk's instructions
		Copy-File -Path "$dirFiles\update.bat" -Destination "$envProgramFiles\Autodesk\webdeploy\meta"
		#Create scheduled task from XML that calls the batch file copied
		schtasks.exe /Create /TN "Fusion360-Update" /XML "$dirFiles\Fusion 360 Update.xml"
		##*===============================================
		##* POST-INSTALLATION
		##*===============================================
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'fusion360' -CloseAppsCountdown 60
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDxx2xyKs1ZldHw
# CMGfJpM2OGCEwngr4B4ehaRGxiBRFqCCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg/VHnucxbaqNP
# 8V6yRzstJKw/xdl2AGwbSvMDJWjGJW4wDQYJKoZIhvcNAQEBBQAEggGAlI8UoPKu
# 9t/kUc1UMXH1p+D77QeAb8Ciw2YFsEQ55v/zVZGiXSiL/G5cmyIDY3HFev2NthaD
# /EdJPOg2nfDj96VtKujyNHUQFmEnprGk7VVIhk4N+KuFY0TqWkakgsojuhOcfA1X
# IvbDoOFp14lZVoBJdVS7P1002e7YwgMfwNcKsvwHfYR2aV5y/zpZ+Atp3ZStu+O/
# 54qHNAjkS0D7xpHbT74orY2szyuKiB3Pl7amEw8gfjndZsxKboFX1nBuQ1GBsZp2
# mwJImnnsntcFCxyItnIxA3fPf2MSnIRzyEzDEVIWp3gwEwjbTt9nP1mKxcGCAsY3
# i5iTXnVs4fXxPAgiNNKB3mP2nTKl/FVm4nQFyDu8Tu68vDyCcuH722cuI4MsJ59Z
# fyAJd/JfBhj5neBwbso3vfxZxasBaRdDOQirLxCeBKCdcW7gtopk2at315tbSuxx
# nAvvA87JHl5hv+RxJlz8Ld1BuNdsV+lUtHc5ZtbOimhJSMG1p48J7356oYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMzAyMTUy
# MjQ0NTVaMD8GCSqGSIb3DQEJBDEyBDCDTJva5nwYmICEjoKuuP/LvZXVwF2gTJG/
# 075TogNhnzszV2p3UJ3NfIlN3lmeVMowDQYJKoZIhvcNAQEBBQAEggIAO5TmQPnh
# BDAD0oVr6z98I1XDFctgfNO/AKn+rq7YknKWk5zu9VvYdv7GaGTa6RnP9c9e7Gl8
# 5aUpomFsmjkNnasAqUuR8jlBJze4u3OAZUEmknyQ0KZ35bKt36kb0uc2Z9rOnIA8
# Iw0Q4XSwIJObDPY1+LjorKnWcXrfAdMnAjAK9lg1iDZYXFatQ7gU9reCo3J+eHHk
# ZvXpk33o4tL8aXqYj7Fa3Frnp2esLC3jsnW0z/7we4xCWMBQ3FFd9qtkKrM9MX7G
# NZrYd5nK6zZNybBYN2/Y/r9AL93YVbMy/GxCHkv8B9obLaW0sVWv4DNxsaoB/amV
# p43YsDBd11jVdMH0/2sdNCNnqkMHZoRN6WJMGVg+XUoqY044j2Oao8Lvlh6Knl1N
# lOq4j1neYdkwbCLBM++VyfzElDEi1GmD8SAJ4VTigYZQJkgYWsP4BmpmKYAWZpD1
# V/HkTNtQ3eU3vpDaCWtBko9bhMYiKP5U8Eqi8FHo1GW7qhjJya/5NvG1t9P4hkRH
# 4/51bBK9yqeRLJmqHJoPr91tWG9W7Un+gv5F5UiOPSLxu1AnEHzxCVQsMBZKQiLW
# V9izLwG/fHdTN0T/FKppiyXHJXemFMHjgwjazzO08HJ/H0ttREEqTPVojBntKTjm
# HPuF8bH6qYUwCaXXv/2Jbk/UNlROjxHoYYY=
